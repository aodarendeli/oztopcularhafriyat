        ...
        <div className="best-estate">
            <div className="best-estate-item">
                ...
                <div className="best-estate-content">
                    <h4><Link to="/">Araç Parkuru</Link></h4>
                ...
                <div className="best-estate-features">
                    <div className="d-flex">
                        <div className="best-estate-feature">
                            ...
                            <span>Oztopcular olarak çeşitli araçlarımız ve iş makinelerimiz ile sizler için en pratik ve iyi hizmeti verip bu alanda sektörde sayılı faliyetler göstermekteyiz.</span>
                        </div>
